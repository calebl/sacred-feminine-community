...
- **New group member notifications** - Existing members of a group receive an in-app and push notification (no email) when a new person joins, linking to the group (the joining member is excluded).
