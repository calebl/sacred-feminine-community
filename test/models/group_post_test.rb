...
class GroupPostTest < ActiveSupport::TestCase
  ...
  test "valid with photos attached" do
    post = GroupPost.new(group: groups(:book_club), user: users(:attendee), body: "Photo post")
  ...
  test "rejects non-image photo content types" do
    post = GroupPost.new(group: groups(:book_club), user: users(:attendee), body: "Bad photo")
  ...
  test "rejects photos over 10MB" do
    post = GroupPost.new(group: groups(:book_club), user: users(:attendee), body: "Big photo")
  ...
  test "rejects more than 10 photos" do
    post = GroupPost.new(group: groups(:book_club), user: users(:attendee), body: "Many photos")
    11.times do |i|
